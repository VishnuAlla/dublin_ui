...
Application.$controller("grid_cutomerportfolioController", ["$scope", "DialogService",
    function($scope, DialogService) {
        ...
        $scope.CustomerProfile = function(clientId) {
            ...
            // $scope.Variables.getClientPolicyWithProfileByClientId.setInput({
            //     clientId: clientId
            // });
            // $scope.Variables.getClientPolicyWithProfileByClientId.update({}, function(data) {
            //     $scope.Variables.PolicyProfileDetails.dataSet.navpath = "customerporfolio";
