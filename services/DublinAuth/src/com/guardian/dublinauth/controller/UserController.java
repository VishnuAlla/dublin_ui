...
import com.guardian.dublinauth.service.UserService;
 ...
 * @see User
 */
@RestController("DublinAuth.UserController")
@Api(value = "UserController", description = "Exposes APIs to work with User resource.")
@RequestMapping("/DublinAuth/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

    @Autowired
	@Qualifier("DublinAuth.UserService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public User editUser(@PathVariable("id") String id, @RequestBody User user) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteUser(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public Page<UserRoleMapping> findAssociatedUserRoleMappings(@PathVariable("id") String id, Pageable pageable) {
        ...
        return userService.findAssociatedUserRoleMappings(id, pageable);
    }
