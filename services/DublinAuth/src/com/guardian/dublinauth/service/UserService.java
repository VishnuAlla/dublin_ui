...
public interface UserService {
	 ...
	 */
	User getById(String userIdInstance) throws EntityNotFoundException;
	 ...
	 * @return User associated with the given userIdInstance.
	 */
	User findById(String userIdInstance);
	 ...
	 */
	User delete(String userIdInstance) throws EntityNotFoundException;
    ...
    /*
     * Returns the associated userRoleMappings for given User id.
     *
     ...
     * @see Page
     */
    Page<UserRoleMapping> findAssociatedUserRoleMappings(String userId, Pageable pageable);
