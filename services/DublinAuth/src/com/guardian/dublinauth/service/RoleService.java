...
public interface RoleService {
	 ...
	 *
	 * @param roleIdInstance The id of the Role to get; value cannot be null.
	 * @return Role associated with the given roleIdInstance.
     * @throws EntityNotFoundException If no Role is found.
	 */
	Role getById(String roleIdInstance) throws EntityNotFoundException;
	 ...
	 * @return Role associated with the given roleIdInstance.
	 */
	Role findById(String roleIdInstance);
	 ...
	 *
	 * @param roleIdInstance The id of the Role to be deleted; value cannot be null.
	 * @return The deleted Role.
	 * @throws EntityNotFoundException if no Role found with the given id.
	 */
	Role delete(String roleIdInstance) throws EntityNotFoundException;
    ...
    /*
     * Returns the associated userRoleMappings for given Role id.
     *
     * @param roleId value of roleId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated UserRoleMapping instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<UserRoleMapping> findAssociatedUserRoleMappings(String roleId, Pageable pageable);
